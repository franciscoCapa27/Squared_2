...
signal trait_purchase_reveal(target_square_id: String, trait_family_display: String, trait_rarity_display: String, trait_roman_stack: String, square_title: String, previous_square_title: String)
